...
******************************************************************/
	...
	$yourEmail = 'scottfot@dscottclark.com'; 
	
	$contactTemplate = 'dark';
	
	$autoResponder = true;
	
	$defaultSubject = 'Contact submission from dscottclark.com';
	...
	$redirectToURL = 'http://codecanyon.net/item/easy-php-contact-form-script/8284762?ref=codeadik';
	...
	$smtpPort = 587;                    
	$smtpUsername = 'dscottclark.design@gmail.com'; 
	$smtpPassword = 'This is 4 the runts!';  
	$smtpEncryption = 'ssl';               
	...
	$easyForm->createPhone('telephone', 'Tel. Number', false, 20);
	...
	// $easyForm->createLocationDetection('Location', false);
